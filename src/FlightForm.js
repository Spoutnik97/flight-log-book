    ...
    render() {
        return (
            <form>
                ...
                <label>
                    Heure début :
                    <input type="time" name="departureTime" onChange={this.handleChange} />
                </label>
                ...
                <label>
                    Nom du CDB :
                    <input type="text" value={this.state.picName} name="picName" size="4" onChange={this.handleChange} />
                </label>
                ...
                <label>
                    Aérodrome départ :
                    <input type="text" name="departureAirport" size="4" onChange={this.handleChange} />
                </label>

                <label>
                    Aérodrome arrivée :
                    <input type="text" name="arrivalAirport" size="4" onChange={this.handleChange} />
                </label>
                ...
                <label>
                    ...
                    <input type="number" name="dayLanding" value={this.state.dayLanding} size="1" onChange={this.handleChange} />
                </label>

                <label>
                    Nombre atterrissages de nuit :
                    <input type="number" name="nightLanding" size="1" value={this.state.nightLanding} onChange={this.handleChange} />
                </label>

                <label>
                    Nombre d'approches IFR :
                    <input type="number" name="ifrApproach" size="1" value={this.state.ifrApproach} onChange={this.handleChange} />
                </label>

                <label>
                    Nombre de remises de gaz :
                    <input type="number" name="goAround" size="1" value={this.state.goAround} onChange={this.handleChange} />
                </label>
